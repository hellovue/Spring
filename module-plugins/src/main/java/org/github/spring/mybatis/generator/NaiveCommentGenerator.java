...
import static org.github.spring.mybatis.generator.NaivePluginAdapter.JOINER;
...
public class NaiveCommentGenerator extends DefaultCommentGenerator {
  ...
  public void addJavaFileComment(CompilationUnit compilationUnit) {
    ...
    compilationUnit.addFileCommentLine("// The file is automatically generated by the program, do not manually modify. ");
    compilationUnit.addFileCommentLine("//*****************************************************************************");
    compilationUnit.addFileCommentLine("");
  }
  ...
  public void addModelClassComment(TopLevelClass topLevelClass, IntrospectedTable introspectedTable) {
    ...
    topLevelClass.addJavaDocLine(" * @version " + new SimpleDateFormat("yyyy-MM-dd").format(new Date()));
    topLevelClass.addJavaDocLine(" */");
  }
